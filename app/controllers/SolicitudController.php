...
class SolicitudController extends ControladorBase {
    ...
    public function editarSolicitudAlumno(){
        ...
        $dao->objeto->setId($_REQUEST["idEditar"]);

        echo $dao->editarDatos();
       echo $dao->editarDatosPadre();
       echo $dao->editarDatosResponsable();
        echo $dao->editarOtrosDatos();

...
class DaoUsuario extends DaoBase {
    ...
    public function mostrarUsuarios() {
        ...
        while($fila = $resultado->fetch_assoc()) {
            ...
            $btnEditar = '<button id=\"'.$fila["codigoUsuario"].'\" nombre=\"'.$fila["nombre"].'\" apellido=\"'.$fila["apellido"].'\" fechaNac=\"'.$fila["fechaNac"].'\" dui=\"'.$fila["dui"].'\" telefono=\"'.$fila["telefono"].'\" correo=\"'.$fila["email"].'\" direccion=\"'.$fila["direccion"].'\"  class=\"ui btnEditar icon blue small button\"><i class=\"edit icon\"></i> Ver Detalles</button>';

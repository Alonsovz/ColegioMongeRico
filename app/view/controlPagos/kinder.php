<?php
  ...
  where f.grado=11 and p.anio = year(CURRENT_DATE()) and p.estado=1 order by f.nombre asc");
 ?>
<div id="app">
        <div class="ui grid">
                <div class="row">
                        ...
                        <a href="?1=PagosController&2=prekinder" class="ui compact blue button" id="prekinder">Prekinder</a>
                                ...
                                <a href="?1=PagosController&2=novenoGrado" class="ui compact gray button" id="noveno">9no Grado</a>
                                  <br><br>
                                <font color="#7BC1AC" size="6px">
                                <i class="file icon"></i><i class="dollar icon"></i>
                                Control de pagos kinder</font>
        ...
        <table class="ui selectable very compact celled table" style="width:100%; margin:auto; text-align:center;">
            <thead>
                <tr>
                    <th style="background-color: #7BC1AC; color:white;">Nombre del Alumno/a</th>
                    <th style="background-color: #7BC1AC; color:white;">Talonario</th>
                    <th style="background-color: #7BC1AC; color:white;">Enero</th>
                    <th style="background-color: #7BC1AC; color:white;">Febrero</th>
                    <th style="background-color: #7BC1AC; color:white;">Marzo</th>
                    <th style="background-color: #7BC1AC; color:white;">Abril</th>
                    <th style="background-color: #7BC1AC; color:white;">Mayo</th>
                    <th style="background-color: #7BC1AC; color:white;">Junio</th>
                    <th style="background-color: #7BC1AC; color:white;">Julio</th>
                    <th style="background-color: #7BC1AC; color:white;">Agosto</th>
                    <th style="background-color: #7BC1AC; color:white;">Septiembre</th>
                    <th style="background-color: #7BC1AC; color:white;">Octubre</th>
                    <th style="background-color: #7BC1AC; color:white;">Noviembre</th>
                </tr>
            </thead>
            <tbody>
...
<script>
 ...
 <script>
    ...
    $("#kinder").removeClass("ui teal button");
    $("#kinder").addClass("ui teal basic button");
    });

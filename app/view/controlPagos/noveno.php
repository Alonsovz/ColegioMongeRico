<?php
  ...
  where f.grado=9 and p.anio = '".$anio."' and p.estado=1  and f.idEliminado=1 order by f.nombre asc");
 ?>
<div id="app">
        <div class="ui grid">
            <div class="row">
        ...
        <table class="ui selectable very compact celled table" style="width:100%; margin:auto; text-align:center;">
            <thead>
                <tr>
                    <th style="background-color: #948F97; color:white;">Nombre del Alumno/a</th>
                    <th style="background-color: #948F97; color:white;">Talonario</th>
                    <th style="background-color: #948F97; color:white;">Enero</th>
                    <th style="background-color: #948F97; color:white;">Febrero</th>
                    <th style="background-color: #948F97; color:white;">Marzo</th>
                    <th style="background-color: #948F97; color:white;">Abril</th>
                    <th style="background-color: #948F97; color:white;">Mayo</th>
                    <th style="background-color: #948F97; color:white;">Junio</th>
                    <th style="background-color: #948F97; color:white;">Julio</th>
                    <th style="background-color: #948F97; color:white;">Agosto</th>
                    <th style="background-color: #948F97; color:white;">Septiembre</th>
                    <th style="background-color: #948F97; color:white;">Octubre</th>
                    <th style="background-color: #948F97; color:white;">Noviembre</th>
                    <th style="background-color: #948F97; color:white;"><i class="file icon"></i></th>
                </tr>
            </thead>
            <tbody>

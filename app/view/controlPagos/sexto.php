<?php
  ...
  where f.grado=6 and p.anio = '".$anio."' and p.estado=1  and f.idEliminado=1 order by f.nombre asc");
 ?>
<div id="app">
        <div class="ui grid">
            <div class="row">
        ...
        <table class="ui selectable very compact celled table" style="width:100%; margin:auto; text-align:center;">
            <thead>
                <tr>
                    <th style="background-color: brown; color:white;">Nombre del Alumno/a</th>
                    <th style="background-color: brown; color:white;">Talonario</th>
                    <th style="background-color: brown; color:white;">Enero</th>
                    <th style="background-color: brown; color:white;">Febrero</th>
                    <th style="background-color: brown; color:white;">Marzo</th>
                    <th style="background-color: brown; color:white;">Abril</th>
                    <th style="background-color: brown; color:white;">Mayo</th>
                    <th style="background-color: brown; color:white;">Junio</th>
                    <th style="background-color: brown; color:white;">Julio</th>
                    <th style="background-color: brown; color:white;">Agosto</th>
                    <th style="background-color: brown; color:white;">Septiembre</th>
                    <th style="background-color: brown; color:white;">Octubre</th>
                    <th style="background-color: brown; color:white;">Noviembre</th>
                    <th style="background-color: brown; color:white;"><i class="file icon"></i></th>
                </tr>
            </thead>
            <tbody>
            <tbody>

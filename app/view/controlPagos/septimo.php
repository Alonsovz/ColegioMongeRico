<?php
  ...
  where f.grado=7 and p.anio = '".$anio."' and p.estado=1  and f.idEliminado=1 order by f.nombre asc");
 ?>
<div id="app">
        <div class="ui grid">
            <div class="row">
                ...
                <a href="?1=PagosController&2=prekinder" class="ui compact blue button" id="prekinder">Prekinder</a>
                        ...
                        Control de pagos 7mo Grado</font>
        ...
        <table class="ui selectable very compact celled table" style="width:100%; margin:auto; text-align:center;">
            <thead>
                <tr>
                    <th style="background-color: black; color:white;">Nombre del Alumno/a</th>
                    <th style="background-color: black; color:white;">Talonario</th>
                    <th style="background-color: black; color:white;">Enero</th>
                    <th style="background-color: black; color:white;">Febrero</th>
                    <th style="background-color: black; color:white;">Marzo</th>
                    <th style="background-color: black; color:white;">Abril</th>
                    <th style="background-color: black; color:white;">Mayo</th>
                    <th style="background-color: black; color:white;">Junio</th>
                    <th style="background-color: black; color:white;">Julio</th>
                    <th style="background-color: black; color:white;">Agosto</th>
...
<script>
 ...
 <script>
    ...
    $("#septimo").removeClass("ui black button");
    $("#septimo").addClass("ui black basic button");
    });

<?php
  ...
  where f.grado=8 and p.anio = '".$anio."' and p.estado=1  and f.idEliminado=1 order by f.nombre asc");
 ?>
<div id="app">
        <div class="ui grid">
            <div class="row">
                ...
                <a href="?1=PagosController&2=prekinder" class="ui compact blue button" id="prekinder">Prekinder</a>
                                ...
                                <a href="?1=PagosController&2=novenoGrado" class="ui compact gray button" id="noveno">9no Grado</a>
                                   <br><br>
                        <font color="#90D242" size="6px">
                        <i class="file icon"></i><i class="dollar icon"></i>
                        Control de pagos 8vo Grado</font>
        ...
        <table class="ui selectable very compact celled table" style="width:100%; margin:auto; text-align:center;">
            <thead>
                <tr>
                    <th style="background-color: #90D242; color:white;">Nombre del Alumno/a</th>
                    <th style="background-color: #90D242; color:white;">Talonario</th>
                    <th style="background-color: #90D242; color:white;">Enero</th>
                    <th style="background-color: #90D242; color:white;">Febrero</th>
                    <th style="background-color: #90D242; color:white;">Marzo</th>
                    <th style="background-color: #90D242; color:white;">Abril</th>
                    <th style="background-color: #90D242; color:white;">Mayo</th>
                    <th style="background-color: #90D242; color:white;">Junio</th>
                    <th style="background-color: #90D242; color:white;">Julio</th>
                    <th style="background-color: #90D242; color:white;">Agosto</th>
                    <th style="background-color: #90D242; color:white;">Septiembre</th>
                    <th style="background-color: #90D242; color:white;">Octubre</th>
                    <th style="background-color: #90D242; color:white;">Noviembre</th>
                    <th style="background-color: #90D242; color:white;"><i class="file icon"></i></th>
                </tr>
            </thead>
            <tbody>

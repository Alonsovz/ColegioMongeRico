...
var app = new Vue({
        ...
        methods: {
            ...
            cargarDatos(){
                ...
                fetch("?1=MateriasOrientadoresController&2=datosGenerales&grado="+1)
                    .then(response => {
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        swal({
                            ...
                            text: 'Se ha asignado el orientador y los docentes que impartirán las materias de primer grado',
                            type: 'success',
                            showConfirmButton: true,

                        }).then((result) => {
                            location.href ="?1=MateriasOrientadoresController&2=primerGrado";
                        }); 

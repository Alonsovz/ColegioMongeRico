...
<div id="app">
        <div class="ui grid">
            <div class="row">
                    ...
                    Asignación de materias y orientador de séptimo grado</font>
        ...
        <div class="fields">
                <div class="eight wide field" style="text-align:left; border: 2px solid black; border-radius: 18px 18px 18px 18px;">
    ...
    <center>
        <button class="ui black button" id="guardarTodo"><i class="save icon"></i>Guardar todo</button>
    </center>
...
var app = new Vue({
        ...
        methods: {
            ...
            cargarDatos(){
                ...
                fetch("?1=MateriasOrientadoresController&2=datosGenerales&grado="+7)
                    .then(response => {
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        swal({
                            ...
                            text: 'Se ha asignado el orientador y los docentes que impartirán las materias de séptimo grado',
                            type: 'success',
                            showConfirmButton: true,

                        }).then((result) => {
                            location.href ="?1=MateriasOrientadoresController&2=septimoGrado";
                        }); 

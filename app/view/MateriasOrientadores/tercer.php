...
<div id="app">
        ...
        <div class="fields">
                <div class="eight wide field" style="text-align:left; border: 2px solid #DBA206; border-radius: 18px 18px 18px 18px;">
    ...
    <center>
        <button class="ui yellow button" id="guardarTodo"><i class="save icon"></i>Guardar todo</button>
    </center>

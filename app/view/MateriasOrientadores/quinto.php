...
<div id="app">
        <div class="ui grid">
            <div class="row">
                    ...
                    <a href="?1=MateriasOrientadoresController&2=novenoGrado" class="ui gray button" id="noveno">9no Grado</a>
                     <br><br>
                    <font color="#7401DF" size="6px">
                    <i class="users icon"></i><i class="book icon"></i>
                    Asignación de materias y orientador de quinto grado</font>
        ...
        <div class="fields">
                <div class="eight wide field" style="text-align:left; border: 2px solid #7401DF; border-radius: 18px 18px 18px 18px;">
    ...
    <center>
        <button class="ui violet button" id="guardarTodo"><i class="save icon"></i>Guardar todo</button>
    </center>
...
var app = new Vue({
        ...
        methods: {
            ...
            cargarDatos(){
                ...
                fetch("?1=MateriasOrientadoresController&2=datosGenerales&grado="+5)
                    .then(response => {
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        swal({
                            ...
                            text: 'Se ha asignado el orientador y los docentes que impartirán las materias de quinto grado',
                            type: 'success',
                            showConfirmButton: true,

                        }).then((result) => {
                            location.href ="?1=MateriasOrientadoresController&2=quintoGrado";
                        }); 

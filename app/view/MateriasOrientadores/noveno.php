...
<div id="app">
        <div class="ui grid">
            <div class="row">
                    ...
                    Asignación de materias y orientador de noveno grado</font>
        ...
        <div class="fields">
                <div class="eight wide field" style="text-align:left; border: 2px solid #848484; border-radius: 18px 18px 18px 18px;">
    ...
    <center>
        <button class="ui gray button" id="guardarTodo" style="color:black;"><i class="save icon"></i>Guardar todo</button>
    </center>
...
var app = new Vue({
        ...
        methods: {
            ...
            cargarDatos(){
                ...
                fetch("?1=MateriasOrientadoresController&2=datosGenerales&grado="+9)
                    .then(response => {
                ...
                success: function(r) {
                    if(r == 1) {
                        ...
                        swal({
                            ...
                            text: 'Se ha asignado el orientador y los docentes que impartirán las materias de noveno grado',
                            type: 'success',
                            showConfirmButton: true,

                        }).then((result) => {
                            location.href ="?1=MateriasOrientadoresController&2=novenoGrado";
                        }); 

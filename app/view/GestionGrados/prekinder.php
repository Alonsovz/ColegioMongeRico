                ...
                <table id="dtNomina" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #2F5FDF; color:white;">N°</th>
                            <th style="background-color: #2F5FDF; color:white;">NIE</th>
                            <th style="background-color: #2F5FDF; color:white;">Nombre</th>
                            <th style="background-color: #2F5FDF; color:white;">Acciones</th>

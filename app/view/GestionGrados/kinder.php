        ...
        <div class="ui grid">
            ...
            <div class="titulo">
                    ...
                    <a href="?1=GestionGradosController&2=novenoGrado" class="ui gray button" id="noveno">9no Grado</a>
                     <br><br>
                    <font color="#1AAEA5" size="6px">
                    <i class="user icon"></i><i class="book icon"></i>
                    Gestión de Kinder</font>
                ...
                <table id="dtNomina" class="ui selectable very compact celled table" style="width:100%; margin:auto;">
                    <thead>
                        <tr>
                            ...
                            <th style="background-color: #1AAEA5; color:white;">N°</th>
                            <th style="background-color: #1AAEA5; color:white;">NIE</th>
                            <th style="background-color: #1AAEA5; color:white;">Nombre</th>
                            <th style="background-color: #1AAEA5; color:white;">Acciones</th>
